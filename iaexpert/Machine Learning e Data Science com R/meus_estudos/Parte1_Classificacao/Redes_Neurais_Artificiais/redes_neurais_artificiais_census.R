...
classificador = h2o.deeplearning(y = 'income',
                                 ...
                                 hidden = c(100),
                                 epochs = 1000)
# Meu código não está funcionando corretamente. Sem a conversão do atributo income no início do script, ocorre um erro
# na biblioteca h2o. Se eu faço a conversão, a transformação dos valores na variável previsões não está ocorrendo como
# deveria e aí, no momento de gerar a matriz de confusão, o número de erros está absurdamente alto.
